...
> ecossistema-sumario antes de qualquer ação.
...
| Arquivo | Descrição | Quando consultar |
|---|---|---|
| [`docs/arquitetura.md`](./docs/arquitetura.md) | Arquitetura v2.0: 6 tipos (M,S,D,W,A,P), camadas, relações entre tipos, S04, repositório âncora | Para entender a arquitetura atual do ecossistema |

## Subpasta — projetos/

| Arquivo | Descrição | Quando consultar |
|---|---|---|
| [`projetos/README.md`](./projetos/README.md) | Política de visibilidade do monitoramento público | Para entender como projetos são tornados públicos |
| [`projetos/monitoramento.md`](./projetos/monitoramento.md) | Painel público de projetos em execução, entregues e planejados | Para ver o status dos projetos da DTD |
